...
<body style="background-color: black;">
    ...
    class MyElement extends HTMLElement {
      constructor() {
        ...
        template.innerHTML = `
          ...
          <br><br>
            <a class="animate-bounce" style="margin-bottom: 200px; text-decoration: none; margin-left: 25%; font-size: 40px; color: white;" href="#solution">
                scroll more 👇
            </a>
        `;
  ...
  <footer>
    <hr />
    <div class="card-container" id="solution">
  <?php
